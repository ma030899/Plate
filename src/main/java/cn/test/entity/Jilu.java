...
public class Jilu  {
	...
	private Admin work;//经办的工作人员
	
	private int jishuid;//技术人员ID，外键
	
	private Admin jishu;//技术人员
	...
	public Admin getWork() {
		return work;
	}

	public void setWork(Admin work) {
		this.work = work;
	}

	public Admin getJishu() {
		return jishu;
	}

	public void setJishu(Admin jishu) {
		this.jishu = jishu;
	}
