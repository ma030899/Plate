...
public class IndexController {
	...
	public String index(HttpServletRequest request,HttpServletResponse response){
		...
		List<CarState> carlist=new ArrayList<CarState>();
		carlist=	carService.selectBeanList(0, 4, null,null,null,null);
	...
	public String carlist(HttpServletRequest request,String pagenum,String pinpai,String xinghao,String yanse){
		...
		//查询列表
		List<CarState> list = carService.selectBeanList((currentpage - 1)* pageSize, pageSize, null,pinpai,xinghao,yanse);
	...
	public void register2(HttpServletRequest request,HttpServletResponse response,Admin user){
		
		PrintWriter writer = this.getPrintWriter(response);

		Admin bean = userService.useryz(user.getUsername());
	...
	public void login2(HttpServletRequest request,HttpServletResponse response,String username,String password){
		...
		Admin bean = userService.userlogin(username, password, 4);
	...
	public void password2(HttpServletRequest request,HttpServletResponse response,String password1,String password2){
		...
		HttpSession session = request.getSession();
		Admin user = (Admin) session.getAttribute("qiantai");
		
		
		Admin bean = userService.userlogin(user.getUsername(), password1, 4);
	...
	public String userupdate(HttpServletRequest request){
		...
		Admin bean = userService.selectBeanById(user.getId());
	...
	public void yudingupdate2(HttpServletRequest request,HttpServletResponse response,int id) throws IOException{
		...
		CarState car = carService.selectBeanById(yuding.getCarid());
	...
	public String jilulist(HttpServletRequest request,String pagenum,String chepai){
		...
		request.setAttribute("title", "我的车位");
	...
	public String jiluview(HttpServletRequest request,int id){
		...
		request.setAttribute("title", "车位记录详情");
