...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		<header class="main-header">
			...
			style="background-color: #2ae0c8"> <span class="logo-lg "
			class="fa fa-photo" style="background-color: #2ae0c8"><b>返回<i
					class="fa fa-fw fa-backward"></i></b></span>
		</a>
			</a>
			<nav class="navbar navbar-static-top" role="navigation" style="background-color: #2ae0c8">
						...
						<div class="box-body">
							<div class="form-group">
								<label for="exampleInputPassword1"><i
									class="fa fa-fw fa-user"></i>车牌号码</label> <input type="text"
									style="width: 20%; margin-left: 550px; border: 1px solid red"
									class="form-control" name="userName" value="${user.carNum }"
									id="exampleInputEmail1" readonly="readonly">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1"><i
									class="fa fa-fw fa-user"></i>车牌颜色</label> <input type="text"
									style="width: 20%; margin-left: 550px; border: 1px solid red"
									class="form-control" name="userName" value="${user.carCor }"
								 readonly="readonly">
							</div>
