...
<input class="layui-btn layui-btn-xs"  onclick="javascript:window.location.href='${url2}add.do';"  type="button" value="添加公告" style="height: 28px;width: 100px;" />
<input name="gbiaoti" type="text"  value="${gbiaoti }" placeholder="请输入公告标题：" style="height:28px">
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1 class="layui-table">	
    ...
    <TR >
    <TD align="center" data-field="id">${bean.gbiaoti }</TD>
    <TD align="center" data-field="id">${bean.ctime }</TD>
