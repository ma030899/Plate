			...
			<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1
				...
				<TR height=>
					<TD align="center" data-field="id"
						style="background-color: #A9A9A9">公告标题:</TD>
					<TD align="center" data-field="id"><input type="text"
						name="gbiaoti" id='gbiaotiid' size="50"
						style="height: 40; border: 0" placeholder="请输入公告标题：" /></TD>
				</TR>
				<TR height=>
					<TD align="center" data-field="id"
						style="background-color: #A9A9A9">公告内容:</TD>
					<TD align="center" data-field="id"><textarea rows="8"
							cols="100" name="gneirong" style="border: 0" placeholder="由此写入："></textarea>
					</TD>
				</TR>
				<TR height=>
					<TD align="center" data-field="id"
