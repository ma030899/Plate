...
<input name="xingming" type="text"  value="${xingming }" placeholder="请输入用户姓名：" style="height:28px">
<input name="sfz" type="text"  value="${sfz }" placeholder="请输入身份证号：" style="height:28px">
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1 class="layui-table"> 	
    ...
    <TD align="center" data-field="id">${bean.shijian2 }</TD>
    <TD align="center" data-field="id">${bean.car.zujin }</TD>
    <TD align="center" data-field="id">${bean.tianshu }</TD>
    <TD align="center" data-field="id">${bean.tzujin }</TD>
    <TD align="center" data-field="id">${bean.weixiu }</TD>
    <TD align="center" data-field="id">${bean.weixiu+bean.tzujin }</TD>
    <TD align="center" data-field="id"> 	
	  <a href="${url2 }update3.do?id=${bean.id }" class="layui-btn">查看</a>
      &nbsp;
      <a href="${url2 }update7.do?id=${bean.id }" class="layui-btn layui-btn-normal">确认支付</a>
      &nbsp;
    </TD>
    </TR>
    </c:forEach>   
