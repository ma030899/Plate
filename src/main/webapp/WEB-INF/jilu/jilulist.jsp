...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1 class="layui-table">
    ...
    <TD align="center" data-field="id" style="background-color:	#A9A9A9">状态</TD>
    ...
    <TD align="center" data-field="id"> 
      ...
      &nbsp;
      <c:if test="${bean.zhuangtai=='已在车位中'}">
      <a href="${url2 }update.do?id=${bean.id }" class="layui-btn layui-btn-normal">用户出库</a>
      &nbsp;
