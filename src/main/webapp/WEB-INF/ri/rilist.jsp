...
<BODY>
	...
	<form action="${url }" method="post">
		<input name="ri" type="text" value="${ri }" placeholder="请输入日期："
			style="height: 28px"> <input type="submit" value="查询"
			class="layui-btn layui-btn-xs" style="height: 28px" />
	</form>
	<div class="layui-table-box">
		<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1
			...
			<TR>
				<TD align="center" data-field="id" style="background-color: #A9A9A9">日期</TD>
			...
			<c:forEach items="${list}" var="bean">
				<TR>
					<TD align="center" data-field="id">${bean.ri }</TD>
