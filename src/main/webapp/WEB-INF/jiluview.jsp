...
border=0>
  ...
  <TR>
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
     ...
     <tr>
     <td width='11%'>入库时间：</td><td width='39%'>${bean.shijian1 }</td>
     <td width='11%'>出库时间：</td><td width='39%'>${bean.shijian2 }</td>
     </tr>
     ...
     <td colspan="3">
      ...
      <tr>
     <td width='11%'>已占时间：</td><td width='39%'>${bean.shijian1 }</td>
     ...
     <a href="index" style="color:red">担心的话可以看看您的车</a>
     &nbsp;&nbsp;
