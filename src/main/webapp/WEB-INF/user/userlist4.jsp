...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=1 class="layui-table">
    ...
    <TD align="center" data-field="id" style="background-color:	#A9A9A9">手机号</TD>
    <TD align="center" data-field="id" style="background-color:	#A9A9A9">注册时间</TD>
    ...
    <TD align="center" data-field="id"><a href="vipcharge.do?username=${bean.username }" class="layui-btn layui-btn-normal">充值</a> </TD> 
